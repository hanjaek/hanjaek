...
- 스스로 할 일을 찾아가며, **문제를 발견하는 순간** 깊이 **몰입하는 성향**을 가지고 있습니다.
- **가설**을 세우고 **검증**하고 **개선**하는 과정을 통해 문제를 해결하는 것을 즐깁니다.
- **새로운 기술**을 배우고, 문제 해결에 적용하는 과정에서 흥미를 느낍니다.
- 다양한 분야를 경험하며 새로운 관점을 발견하는 것에 **호기심**을 가지고 있습니다.
- **요구사항 분석**부터 **설계**, **검증**까지 이어지는 **문제 해결 과정**을 중요하게 생각합니다.
...
![Vite](https://img.shields.io/badge/Vite-f5f5f5?style=flat)
...
<div align="center">
  ...
  &nbsp;&nbsp;
  <img
    src="https://mazandi.herokuapp.com/api?handle=hjk2512&theme=cold"
    height="170"
  />
</div>
